...
nonisolated enum ProjectError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .invalid: localizedString("This is not a valid Compositor project, or its metadata is damaged.")
        case .version(let version): String(format: localizedString("This project uses format version %lld. This app supports versions 1–8."), version)
        case .missingImage: localizedString("An image inside the project is missing or damaged. The current document has not been replaced.")
        case .tooLarge: localizedString("This project exceeds the supported canvas, layer, file-size, or 100-megapixel image limit.")
        case .encode: localizedString("An image could not be saved. The previous project has not been replaced.")
        }
    }
}
