...
nonisolated enum ProjectError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .invalid: L10n.string("This is not a valid Compositor project, or its metadata is damaged.")
        case .version(let version): L10n.format("This project uses format version %1$@. This app supports versions 1–7.", String(version))
        case .missingImage: L10n.string("An image inside the project is missing or damaged. The current document has not been replaced.")
        case .tooLarge: L10n.string("This project exceeds the supported canvas, layer, file-size, or 100-megapixel image limit.")
        case .encode: L10n.string("An image could not be saved. The previous project has not been replaced.")
        }
    }
}
