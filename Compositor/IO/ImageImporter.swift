...
nonisolated enum ImageImportError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .unreadable: L10n.string("The image could not be read. It may be damaged or unavailable.")
        case .unsupported: L10n.string("Choose a JPEG, PNG, HEIC, or TIFF image.")
        case .tooLarge: L10n.string("This import exceeds the current 100-megapixel document budget or 30,000-pixel side limit.")
        }
    }
}
