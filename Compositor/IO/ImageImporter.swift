...
nonisolated enum ImageImportError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .unreadable: "The image could not be read. It may be damaged or unavailable.".localized
        case .unsupported: "Choose a JPEG, PNG, HEIC, or TIFF image.".localized
        case .tooLarge: "This import exceeds the current 100-megapixel document budget or 30,000-pixel side limit.".localized
        }
    }
}
