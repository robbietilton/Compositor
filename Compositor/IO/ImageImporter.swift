...
nonisolated enum ImageImportError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .unreadable: localized("The image could not be read. It may be damaged or unavailable.")
        case .unsupported: localized("Choose a JPEG, PNG, HEIC, TIFF, or Photoshop (PSD) file.")
