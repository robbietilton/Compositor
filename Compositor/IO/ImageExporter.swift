...
nonisolated enum ExportError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .tooLarge: "Image export supports canvases up to 100 megapixels and 30,000 pixels per side.".localized
        case .render: "The canvas could not be rendered. Try a smaller canvas.".localized
        case .encode: "The image could not be encoded.".localized
        }
    }
}
