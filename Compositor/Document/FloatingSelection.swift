...
extension EditorSession {
    ...
    func beginSelectionTransform() async {
        ...
        var floating = ImageLayer(asset: ImportedImage(image: lifted.image, thumbnail: thumbnail, name: L10n.text("Floating Selection")),
                                  origin: lifted.region.origin)
        floating.name = L10n.text("Floating Selection")
