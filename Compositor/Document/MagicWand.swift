...
nonisolated enum MagicWand {
    enum Failure: LocalizedError {
        ...
        var errorDescription: String? {
            switch self {
            case .tooDetailed: localized("That selection is too detailed to outline. Try a different Tolerance, or turn on Contiguous.")
            case .memory: localized("There isn’t enough memory to make that selection.")
            }
        }
    }
