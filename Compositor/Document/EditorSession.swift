...
final class EditorSession {
    ...
    var fillToolMode = FillToolMode.gradient
    var bucketSettings = WandSettings()
    ...
    func cycleToolMode() {
        ...
        case .gradient: changeFillToolMode(next(fillToolMode))
        default: break
        }
    }
